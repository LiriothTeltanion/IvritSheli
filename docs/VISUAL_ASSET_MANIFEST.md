...
Every letterform in the Ivrit Sheli marks used by the icon and social card is a
drawn path. Supporting social-card copy remains SVG text and is flattened into
the public PNG by `frontend/scripts/build-social-preview.mjs`. The Latin half
was drawn on 2026-08-23; the Hebrew signature followed on 2026-08-24, its
contours extracted from the bundled TTF with `fontTools`.
...
| `frontend/public/icons/app-icon-512.png` | 319,376 bytes | `cd666daf996d5ab0e274e8961f28f241dfb66ae06ed7c33a1327a95a654d0409` | High-resolution install icon. |
| `assets/social/ivrit-sheli-social-preview.png` | 478,413 bytes | `c2463ea1c975dda2411c2be4014e6455b9e5e0186a42d52a6f135ee9bff90a29` | Versionless og:image and Twitter card generated deterministically from the Nocturne SVG; both public PNG copies are byte-identical. |
