# Architecture — Ivrit Sheli 2.0

Ivrit Sheli 2.0 has two deliberate runtime modes. The original private SQLite application remains the simplest offline installation; the cloud mode adds authenticated multi-user delivery without duplicating or weakening the learning engine.
...
Browser: React 19 + TypeScript + PWA + EN/ES/HE + RTL
                         ...
                         ▼
Ivrit Sheli 2.0 FastAPI application
