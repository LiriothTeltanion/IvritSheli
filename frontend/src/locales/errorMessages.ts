...
export const errorMessages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    import_busy: 'Another restore is already running. Wait a moment and try again.',
  ...
  es: {
    ...
    import_busy: 'Ya hay otra restauración en marcha. Espera un momento e inténtalo otra vez.',
  ...
  he: {
    ...
    import_busy: 'שחזור אחר כבר פועל. יש להמתין רגע ולנסות שוב.',
