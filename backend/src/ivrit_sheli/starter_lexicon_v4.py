...
HOUSING = _category(
    ...
    (
        ...
        _Row("קומה", "קוֹמָה", "koma", "noun", "floor; story", "piso; planta", "housing.floor", "4️⃣", "a fourth-floor button in an elevator", "un botón del cuarto piso en un ascensor", "כפתור קומה רביעית במעלית", "הדירה בקומה ארבע.", "The apartment is on the fourth floor.", "El apartamento está en el cuarto piso.", "Ha-dira be-koma arba.", "feminine"),
...
REGISTER = _category(
    ...
    (
        ...
        _Row("אפשר לעזור", "אֶפְשָׁר לַעֲזוֹר", "efshar la'azor", "phrase", "can I help?", "¿puedo ayudar?", "register.offer_help", "🤝", "a person offering practical help", "una persona ofreciendo ayuda práctica", "אדם מציע עזרה מעשית", "אפשר לעזור לך?", "Can I help you?", "¿Puedo ayudarte?", "Efshar la'azor lekha?"),
